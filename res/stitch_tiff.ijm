...
// --------- calculate shifts ----------
run("Calculate pairwise shifts ...", "select="+file+"_stitched/dataset.xml process_angle=[All angles] process_channel=[All channels] process_illumination=[All illuminations] process_tile=[All tiles] process_timepoint=[All Timepoints] method=[Phase Correlation] channels=[use Channel 1] downsample_in_x=4 downsample_in_y=4 downsample_in_z=2");
